...
<center>
	...
	if(isset($_POST['message']))
	{
	    ...
	    $q="insert into message values(null,'$lid','$selectedid','$messages',curdate())";
		insert($q);
		alert("Message Send");
		
		return redirect("teachermessages.php?selectedid=$selectedid");
	}
	?>
...
<table align="center" style="width:380px;" class="table">
	...
	$q="SELECT * FROM message WHERE (`sender_id`='$lid' AND receiver_id='$selectedid') OR(`sender_id`='$selectedid' AND receiver_id='$lid') ";
	$result=select($q);
